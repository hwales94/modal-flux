    ...
    with tqdm(
        ...
        for i, data in enumerate(train_loader):
            ...
            if (i + 1) % log_every == 0 and use_wandb:
                ...
                if not config.benchmark:
                    data["train/acc"] = 100 * train_acc.avg
                    data["train/loss"] = train_loss.avg
                    data["train/lr"] = lr_scheduler.get_last_lr()[0]
                wandb.log(
                    data,
